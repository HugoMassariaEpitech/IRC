const { createPrivateConversation, createGroupConversation } = require('../middleware/export.middleware');
...
router.post("/private_conversation", [createPrivateConversation], conversationController.addConversationToUser);
