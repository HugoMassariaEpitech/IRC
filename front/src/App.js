...
function App() {
  ...
  return (
    <>
      {
        isConnected ? Page == "Chat" ? <Chat handleChannels={handleChannels}/> : <Channel /> : <Connexion handleSubmit={handleSubmit} submitButton={Submit} alternativeButton={Alternative == "Inscription" ? "S'inscrire" : "Se connecter"} handleAlternative={handleAlternative} Banner={Banner} />
      }
    </>
  );
}
